...
$dir = dirname( __FILE__ ) . DIRECTORY_SEPARATOR . '../../ASSETS/register/' . $additionaldir;
if (!is_dir('../../ASSETS/register/' . $additionaldir)) {
	mkdir('../../ASSETS/register/' . $additionaldir, 0777);
}
...
if($a){
	$answer = array('file_name'=>$FIleName, 'answer' => 'File transfer completed', 'file' => 'ASSETS/register/' . $additionaldir . DIRECTORY_SEPARATOR . $newFileName );
}
else {
