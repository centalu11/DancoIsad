...
$dir = dirname( __FILE__ ) . DIRECTORY_SEPARATOR . '../../ASSETS/pictures/' . $additionaldir;
if (!is_dir('../../ASSETS/pictures/' . $additionaldir)) {
	mkdir('../../ASSETS/pictures/' . $additionaldir, 0777);
}
...
if($a){
	$answer = array('file_name'=>$FIleName, 'answer' => 'File transfer completed', 'file' => 'ASSETS/pictures/' . $additionaldir . DIRECTORY_SEPARATOR . $newFileName );
}
else {
