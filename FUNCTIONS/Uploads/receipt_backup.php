...
class PDF extends FPDF
{
	...
	$pdf = new PDF();
		...
		$pdf->SetXY($b,$n);
		$pdf->Cell(10, 4, $v['product_receipt_name_2']."                      ".$v['product_quantity']." @ " .$_GET['pr_price'].".00", 0, 'L');
		$pdf->SetXY($x,$y);
		$tempo_total_3 = $v['product_quantity'] * $_GET['pr_price'];
		$pdf->Cell(10, 4,$tempo_total_3.".00", 0, 'L');
