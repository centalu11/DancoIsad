...
$recipients = ['bunnycustomercare@chrsglobal.com',$_POST['user_address']];
$subject = "Email Confirmation for Accepting the SUA of BUNNY";
$fromEmail = "mailer@thinkaomos.com";
$fromName = "Bunny Mailer";
$bodyText = "Text body";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="padding:0; margin: 0;">
    <table style="height: 100%; width: 100%; background-color: #efefef;" align="center">
      <tbody>
        <tr>
          <td valign="top" id="dbody" data-version="2.26" style="width: 100%; height: 100%; padding-top: 30px; padding-bottom: 30px; background-color: #efefef;">
            ...
            <table class="layer_1" align="center" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px; box-sizing: border-box; width: 100%; margin: 0px auto;">
              <tbody>
                <tr>
                  <td class="drow" valign="top" align="center" style="background-color: #ffbf00; box-sizing: border-box; font-size: 0px; text-align: center;">
                        ...
                        <tbody>
                          <tr>
                            <td valign="top" class="edimg" style="text-align: center; padding: 20px; box-sizing: border-box;">
                              <img src="https://api.elasticemail.com/userfile/76189888-0155-4f88-a18c-784c2ddd9ab8/bunnypos.png" alt="Image" width="215" style="border-width: 0px; border-style: none; max-width: 215px; width: 100%;">
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <td class="drow" valign="top" align="center" style="background-color: #ffffff; box-sizing: border-box; font-size: 0px; text-align: center;">
                    ...
                    <div class="layer_2" style="max-width: 600px; display: inline-block; vertical-align: top; width: 100%;">
                      <table class="edcontent" style="border-collapse: collapse;width:100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                          <tr>
                            <td class="edtext" valign="top" style="padding: 20px; text-align: left; color: #5f5f5f; font-size: 12px; font-family: Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;">
                              <p class="style1" style="margin: 0px; padding: 0px; color: #000000; font-size: 28px; font-family: Helvetica, Arial, sans-serif;">
                                <span style="color: #5f5f5f; font-size: 12px;">'.$_POST['message'].'
                                </span>
                              </p>
                            </td>
                          </tr>
